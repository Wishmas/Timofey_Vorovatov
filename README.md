...
| :---------------------- | :---------------------- | :---------------------- |
| [Бот для заучивания слов](https://github.com/Wishmas/Timofey_Vorovatov) | Телеграм-бот, способный через взаимодействие с базой данных Postgresql создавать для пользователя персональную таблицу из пар термин-перевод, а затем выполнять с ними различные манипуляции | `telebot`, `psycopg2` |
